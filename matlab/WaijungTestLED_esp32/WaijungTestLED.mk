...
#                        of executable (1/0)?
MODEL                = WaijungTestLED
MODULES              = WaijungTestLED.c rt_main.c waijung2_hwdrvlib.c
MODULES_OBJ          = WaijungTestLED.obj rt_main.obj waijung2_hwdrvlib.obj 
MAKEFILE             = WaijungTestLED.mk
...
OPTIMIZATION_FLAGS   = 
ADDITIONAL_LDFLAGS   = 
COMPILER_COMMAND_FILE_NAME = WaijungTestLED_comp.rsp

#--------------------------- Model and reference models -----------------------
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = WaijungTestLED_ref.rsp
...
%.o: $(subst ",,$(MATLAB_ROOT)/toolbox/simulink/blocks/src)/%.cpp
	@echo ### Source $< done
...
%.o: $(subst ",,$(MATLAB_ROOT)/toolbox/simulink/blocks/src)/%$(SRC_FILE_EXT)
	@echo ### Source $< done
