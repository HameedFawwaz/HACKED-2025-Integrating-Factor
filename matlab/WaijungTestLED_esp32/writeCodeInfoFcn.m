% Autogenerated file: Sat Feb 15 23:00:03 2025
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("WaijungTestLED",pwd) ;
wr.writeName(codeInfo.Name);
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        ...
        func_Initialize_Prototype.HeaderFile = 'WaijungTestLED.h';
    func_Initialize_Prototype.SourceFile = 'WaijungTestLED.c';
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'WaijungTestLED_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        ...
        func_OutputUpdate_Prototype.HeaderFile = 'WaijungTestLED.h';
    func_OutputUpdate_Prototype.SourceFile = 'WaijungTestLED.c';
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'WaijungTestLED_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        ...
        func_Terminate_Prototype.HeaderFile = 'WaijungTestLED.h';
    func_Terminate_Prototype.SourceFile = 'WaijungTestLED.c';
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['WaijungTestLED_terminate'];
        codeInfo.TerminateFunctions =  [codeInfo.TerminateFunctions, func_Terminate_Interface'];
            ...
            type_RTModel.Identifier = 'RT_MODEL_WaijungTestLED_T';
        ...
        Var_RTModel.Identifier      = 'WaijungTestLED_M_';
        Var_RTModel.Type = Ptrtype_RTModel_1_0.BaseType;
            Var_RTModel.Owner        = 'WaijungTestLED';
            
            Var_RTModel.DeclarationFile = 'WaijungTestLED.h';
            Var_RTModel.DefinitionFile  = 'WaijungTestLED.c';


        % Pointer Variable: PtrVar_RTModel

            PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'WaijungTestLED_M', Var_RTModel);
            
        PtrVar_RTModel.Owner = 'WaijungTestLED';
            PtrVar_RTModel.DeclarationFile = 'WaijungTestLED.h';
            PtrVar_RTModel.DefinitionFile = 'WaijungTestLED.c';
